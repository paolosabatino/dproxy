...
config_param config_params[] = {
  ...
  { 
     ...
     "# Number of worker threads always ready to resolve a query?\n"
     "# Set the number of worker threads higher to allow more concurrent requests!\n",
     &config.worker_threads_count ,
     &config_defaults.worker_threads_count ,
     init_int,
     copy_int ,
     print_int
  } ,
